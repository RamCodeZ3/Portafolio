  ...
  es: {
    translation: {
     ...
     experience: {
      ...
      description4: "Colaboré como desarrollador full-stack en un proyecto de sorteos de loterías, desarrollando la interfaz de usuario del sistema, gestionando la administración de tickets, la base de datos y los servicios de la aplicación para una gestión eficiente.",
     },
     services: {
      title: "Servicios",
  ...
  en: {
    translation: {
     ...
     experience: {
      ...
      description4: "I collaborated as a full-stack developer on a lottery draw platform, developing the user interface, managing ticket administration, handling the database, and implementing application services for efficient system management."
     },
     services: {
      title: "Services",
