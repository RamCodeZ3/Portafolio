...
export default function Header() {
  ...
  return (
    <div className="fixed flex justify-center items-center w-[95.5%] 2xl:w-[80%] max-w-[1550px] h-18 z-10 top-2 p-4">
      <header className="flex w-full z-10 top-0 left-0 py-2 px-2 items-center justify-around bg-[#0091b9]/3 border border-white/10 rounded-lg backdrop-blur-2xl">
